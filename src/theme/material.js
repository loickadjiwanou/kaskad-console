...
export function materialAntdTheme(scheme, algorithm) {
    ...
    return {
        ...
        token: {
            ...
            // Contours des champs : doux au repos (outline variant), plus marqués au survol, primaires au focus
        ...
        components: {
            ...
            Input: { activeShadow: `0 0 0 1px ${c.primary}`, hoverBorderColor: c.outline, activeBorderColor: c.primary, paddingBlock: 8 },
            InputNumber: { activeShadow: `0 0 0 1px ${c.primary}`, hoverBorderColor: c.outline, activeBorderColor: c.primary },
            Select: {
                activeOutlineColor: c.primary,
                hoverBorderColor: c.outline,
                ...
                multipleItemBorderColor: c.outlineVariant,
            },
            DatePicker: { activeShadow: `0 0 0 1px ${c.primary}`, hoverBorderColor: c.outline, activeBorderColor: c.primary, cellActiveWithRangeBg: c.secondaryContainer },
            ...
            Checkbox: { borderRadiusSM: 2, controlInteractiveSize: 18, colorBorder: c.outline },
            Radio: { radioSize: 20, dotSize: 10, colorBorder: c.outline },
